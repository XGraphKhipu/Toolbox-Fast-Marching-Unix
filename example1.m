...
N = 200;                                  %number of points in a mesh
[vertices,faces] = create_hedgehog_mesh(N, 0.1);   %create "noisy sphere" mesh; "vertices" contains 3D vertex coordinates; "faces"
% contains vertex id's for every triangle
...
[source_id, distances] = geodesic_distance_and_source(algorithm);     %find distances to all vertices of the mesh; 
% in this example we have a single source, so source_id is always equal to 1
% 
