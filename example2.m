...
for i = 1:length(analysis);
    ...
    for j=1:length(analysis{i}.algorithm)
        ...
        [source_id, d] = geodesic_distance_and_source(current_algorithm, destination);    %you can confirm that the path length is 
%         equal to the distance estimated by geodesic_best_source
